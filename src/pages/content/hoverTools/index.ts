import removeHighlight from "../highlight/remove"

import $ from "jquery";
import {HIGHLIGHT_CLASS} from "@pages/content/highlight/highlight/constants";
...
function initializeHoverTools() {
    console.log("initializeHoverTools")
    console.log(chrome.runtime.getURL('src/contentScripts/index.js'))
    $.get(chrome.runtime.getURL('src/pages/content/hoverTools/index.html'), (data) => {
        hoverToolEl = $(data);
        hoverToolEl.hide();
...
function getHoverToolEl() {
    console.log("getHoverToolEl")
    console.log("hoverToolEl", hoverToolEl)
