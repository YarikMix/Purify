    ...
    return (
        <div className="flex flex-col justify-between items-center gap-8 w-full h-full">
            <div className="grid grid-flow-row auto-cols-1 gap-4">
                ...
                <button type="button" onClick={handleEstimateSiteBtnClick}
            ...
            {showStats &&
                <SiteInfoSummary site={siteDomen} aggressive={true} aggressivePercentage={47} agitationPercentage={13}
                                 obsceneLanguagePercentage={17} biasPercentage={3}/>}
