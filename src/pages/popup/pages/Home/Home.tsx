...
const Home = () => {
	...
	const handleEstimateSiteBtnClick = async (
		...
		const response = await axios.get(
			API_URL + `/analytics?url=${siteDomen}`,
		);
	...
	return (
		<div className="flex flex-col justify-between items-center gap-8 w-full h-full">
			<div className="grid grid-flow-row auto-cols-1 gap-4">
				<h1 className="text-stone-900 text-lg font-black">
					{siteDomen}
				</h1>
				<button
					type="button"
